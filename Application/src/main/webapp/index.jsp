...
<head>
    ...
    <title>Имитация видеонаблюдения</title>
    <meta name="description" content="Поддельная камера, беспроводная, имитация видеонаблюдения, Внутренняя/наружная, пустышка, купольная камера с мигающим красным светодиодным освещением, Домашняя безопасность">
       ...
       <!--     <div class="navbar-header">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right" id="one-page-nav">
                    ...
                    <li><a href="#feature">Особености</a></li>
                    <li><a href="#description">Почему мы?</a></li>
                    <li><a href="#screenshot">Картинки</a></li>
                <!--    <li><a href="#pricing">Отзывы</a></li>-->
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="banner-text-content">
                                <h1 class="banner-title">Поддельная камера</h1>
                                <p class="banner-text">Моделирование безопасности поддельные Dome Dummy камера со вспышкой светодиодный свет для дома и улицы имитация видео наблюдения беспроводной фейковые камеры</p>
                                <div class="button-group">
                                    <a class="btn btn-lg" href="#">Заказать</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="intro-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                                ...
                                <h4 class="intro-title">Описание</h4>
                                <p class="intro-content">Эта купольная камера безопасности предназначена для имитации небольших высокотехнологичных камер безопасности на рынке сегодня. Он изготовлен из высококачественного и прочного материала. Компактный и простой позволяет быстро установить. Оснащенная мигающим красным светодиодным светом, фиктивная камера обеспечивает эффективное сдерживание. Идеально подходит для дома, офиса, торгового центра и других мест.</p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="intro-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                ...
                                <h4 class="intro-title">Особенности</h4>
                                <p class="intro-content">Реалистичный внешний вид, выглядит как настоящий монитор и камера.<br>
Выглядит как настоящая камера безопасности.<br>
Дешевый и эффективный способ отпугивания элементов.<br>
С красным мигающим светодиодным светом, можно увидеть ночью.<br>
Устанавливается быстро и легко к потолку или стене с помощью прилагаемых винтов.<br>
Защитите свои дома, магазины и бизнес. </p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="intro-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">
                                ...
                                <h4 class="intro-title">Технические характеристики</h4>
                                <p class="intro-content">Источник питания: 2 * батарейки типа АА(Не входит в комплект)<br>
Вес изделия: 140 г<br>
Размер упаковки: 120*118*90<br>
Вес упаковки: 200 г<br>
Материал: пластик<br>
Внешний вид: без сенсорного переключателя, купольная камера<br>
Тип: имитация камеры<br>
Характеристики: красный светодиод с мигающим светом<br>
Рабочее состояние: монитор всегда будет мигать с интервалом в 2 секунды</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-xs-12">
                        <div class="section-header text-center">
                            ...
                            <p class="section-subtext">Поддельная камера, беспроводная, имитация видеонаблюдения</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Дизайн</h4>
                                <p>Реалистичный внешний вид, выглядит как настоящий монитор и камера</p>
                            </div>
                        </div>
                        <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                            <div class="feature-icon">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Реалистичный</h4>
                                <p>Выглядит как настоящая камера безопасности</p>
                            </div>
                        </div>
                        <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                            <div class="feature-icon">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Результат</h4>
                                <p>Дешевый и эффективный способ отпугивания элементов</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Ну, очень точная копия</h4>
                                <p>С красным мигающим светодиодным светом, можно увидеть ночью</p>
                            </div>
                        </div>
                        <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                            <div class="feature-icon">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">Установка</h4>
                                <p>Устанавливается быстро и легко к потолку или стене с помощью прилагаемых винтов</p>
                            </div>
                        </div>
                        <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                            <div class="feature-icon">
                            ...
                            <div class="feature-content">
                                <h4 class="feature-title">К чему мы стремимся?</h4>
                                <p>Защитите свои дома, магазины и бизнес</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Extra Features -->
        <div id="description" class="section section-padding more-feature-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-3 col-sm-4 text-center">
                        <div class="mock">
                            <img class="back-mock wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s" src="images/mocks/features-mock-back.png" alt="mock back">
                            <img class="front-mock wow fadeInUp" data-wow-duration="1.5s" src="images/mocks/features-mock-front.png" alt="mock front">
                        </div>
                    </div>
                    <div class="col-lg-6 col-lg-offset-1 col-md-7 col-md-offset-2 col-sm-6 col-sm-offset-2">
                        <div class="section-header style-2">
                            ...
                            <p class="section-subtext">Эта купольная камера безопасности предназначена для имитации небольших высокотехнологичных камер безопасности на рынке сегодня.</p>
                        </div>
                        <ul class="features icon-list">
                            <li class="extra-feature"><span class="icon-basket"></span>Источник питания: 2 * батарейки типа АА(Не входит в комплект)</li>
                            <li class="extra-feature"><span class="icon-map"></span>Вес изделия: 140 г</li>
                            <li class="extra-feature"><span class="icon-basket"></span>Размер упаковки: 120*118*90</li>
                            <li class="extra-feature"><span class="icon-map"></span>Материал: пластик</li>
							<li class="extra-feature"><span class="icon-basket"></span>Внешний вид: без сенсорного переключателя, купольная камера</li>
                            <li class="extra-feature"><span class="icon-map"></span>Тип: имитация камеры</li>
                            <li class="extra-feature"><span class="icon-basket"></span>Характеристики: красный светодиод с мигающим светом</li>
                            <li class="extra-feature"><span class="icon-map"></span>Рабочее состояние: монитор всегда будет мигать с интервалом в 2 секунды</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-xs-12">
                        <div class="section-header text-center">
                            ...
                            <p class="section-sub">Пару картинок с камерой</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-xs-12">
                        <div class="section-header text-center wow fadeInDown" data-wow-duration="1.5s">
                            ...
                            <p class="section-subtext">Interested! don't hasitate to collect it &amp; enjoy the features of Grape</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <div class="button-group wow fadeInUp" data-wow-duration="1.5s">
                            ...
                            <a class="btn btn-lg btn-download"><i class="fa fa-windows"></i> Win Store</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="contact" class="section contact-area">
            <div class="map-wrap">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 right-image hidden-sm hidden-xs steller-parallax" data-stellar-background-ratio="1">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Как Нам с Вами связаться?</h3>
                                <p class="section-subtext">Если укажете Ваши контакты, то наш менеджер с Вами связажется.</p>
                            </div>
                            <form id="contactForm" class="contact-form" action="#" method="post">
                                ...
                                <p>
                                    <input id="subject" type="text" name="subject" placeholder="Телефон" required>
                                </p>
    ...
    <footer>
        ...
        <div class="copyright-footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <p class="copyright">Copyright 2020, <a href="#">Grape</a>. All Right Reserved</p>
                    </div>
                    <div class="col-md-6 col-xs-12">
                        <ul class="footer-nav">
